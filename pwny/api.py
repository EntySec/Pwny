...
PROCESS_TYPE_PROCESS_ARGV = tlv_custom_type(TLV_TYPE_STRING, PROCESS_BASE, API_TYPE + 2)
PROCESS_TYPE_PROCESS_ENV = tlv_custom_type(TLV_TYPE_STRING, PROCESS_BASE, API_TYPE + 3)
